...
import { DemoDataType, NcActuator, NcDemo, NcGain, NcIdentBeacon, NcIdentBeaconCustom, NcReceiverMonitor, NcReceiverStatus, NcSignalWorker, NcWorker } from './Features';
...
export class NcClassManager extends NcManager
{
    ...
    private GenerateClassDescriptors() : { [key: string]: NcClassDescriptor }
    {
        let register = {
			...
			'1.2.2.0.1': NcIdentBeaconCustom.GetClassDescriptor(false),
